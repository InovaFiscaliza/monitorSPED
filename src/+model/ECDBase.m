classdef ECDBase < handle
    ...
    properties (Access = protected, Constant = true)
        ...
        DATA_FIN_EMP             = struct('DataType', 'datetime', 'Description', 'Data final do período da escrituração contábil da empresa que foi consolidada')
        DATA_INI_EMP             = struct('DataType', 'datetime', 'Description', 'Data inicial do período da escrituração contábil da empresa que foi consolidada.')
        ...
        DT_CRC_T                 = struct('DataType', 'datetime', 'Description', 'Data de validade da Certidão de Regularidade Profissional do Contador')
        DT_EVENTO                = struct('DataType', 'datetime', 'Description', 'Data do evento societário.')
        ...
        DT_FIN_ECD_REC           = struct('DataType', 'datetime', 'Description', 'Data final das informações contidas na ECD recuperada.')
        DT_FIN_ESCR              = struct('DataType', 'datetime', 'Description', 'Data de término da escrituração.')
        DT_FIN_REL               = struct('DataType', 'datetime', 'Description', 'Data do término do relacionamento.')
        ...
        DT_INI_ECD_REC           = struct('DataType', 'datetime', 'Description', 'Data inicial das informações contidas na ECD recuperada.')
        DT_INI_ESCR              = struct('DataType', 'datetime', 'Description', 'Data de início da escrituração.')
        DT_INI_REL               = struct('DataType', 'datetime', 'Description', 'Data do início do relacionamento.')
        ...
        NU_ORDEM                 = struct('DataType', 'cell',     'Description', 'Número de ordem da linha na visualização da demonstração. Ordem de apresentação da linha na visualização do registro J150.')
        NUM_AD                   = struct('DataType', 'cell',     'Description', 'Número sequencial do campo adicional.')
        ...
        NUM_ORD                  = struct('DataType', 'cell',     'Description', 'Número de ordem do instrumento de escrituração.')
        ...
        QTD_LIN_0                = struct('DataType', 'double',   'Description', 'Quantidade total de linhas do Bloco 0.')
        QTD_LIN_9                = struct('DataType', 'double',   'Description', 'Quantidade total de linhas do Bloco 9.')
        QTD_LIN_I                = struct('DataType', 'double',   'Description', 'Quantidade total de linhas do Bloco I.')
        QTD_LIN_J                = struct('DataType', 'double',   'Description', 'Quantidade total de linhas do Bloco J.')
        QTD_LIN_K                = struct('DataType', 'double',   'Description', 'Quantidade total de linhas do Bloco K.')
        QTD_REG_BLC              = struct('DataType', 'double',   'Description', 'Total de registros do tipo informado no campo anterior.')
        ...
        TIP_ECD                  = struct('DataType', 'cell',     'Description', 'Indicador do tipo de ECD: 0 – ECD de empresa não participante de SCP como sócio ostensivo. 1 – ECD de empresa participante de SCP como sócio ostensivo. 2 – ECD da SCP.')
        ...
        VAL_AG                   = struct('DataType', 'double',   'Description', 'Valor absoluto aglutinado')
        VAL_CRED_AUX             = struct('DataType', 'double',   'Description', 'Total dos créditos do dia em moeda funcional, convertida para reais.')
        ...
        VAL_CS                   = struct('DataType', 'double',   'Description', 'Valor absoluto consolidado: VAL_CS = VAL_AG – VAL_EL')
        VAL_DEB_AUX              = struct('DataType', 'double',   'Description', 'Total dos débitos do dia em moeda funcional, convertida para reais.')
        ...
        VAL_EL                   = struct('DataType', 'double',   'Description', 'Valor absoluto das eliminações')
        VALOR                    = struct('DataType', 'double',   'Description', 'Parcela do valor eliminado total')
        VL_CRED                  = struct('DataType', 'double',   'Description', 'Valor total dos créditos do período.')
        VL_CRED_AUX              = struct('DataType', 'double',   'Description', 'Valor total dos créditos do período em moeda funcional.')
        ...
        VL_CRED_REC              = struct('DataType', 'double',   'Description', 'Valor total dos créditos no período.')
        VL_CTA                   = struct('DataType', 'double',   'Description', 'Valor do saldo final antes do lançamento de encerramento.')
        VL_CTA_AUX               = struct('DataType', 'double',   'Description', 'Valor do saldo final antes do lançamento de encerramento em moeda funcional, convertida para reais.')
        ...
        VL_DC_AUX                = struct('DataType', 'double',   'Description', 'Valor da partida em moeda funcional, convertida para reais.')
        ...
        VL_DEB_AUX               = struct('DataType', 'double',   'Description', 'Valor total dos débitos do período em moeda funcional, convertida para reais.')
        VL_DEB_MF                = struct('DataType', 'double',   'Description', 'Total dos débitos do dia em moeda funcional, convertido para reais.')
        VL_DEB_REC               = struct('DataType', 'double',   'Description', 'Valor total dos débitos no período.')
        VL_FAT_CONT              = struct('DataType', 'double',   'Description', 'Valor do fato contábil.')
        VL_LCTO                  = struct('DataType', 'double',   'Description', 'Valor do lançamento.')
        VL_LCTO_AUX              = struct('DataType', 'double',   'Description', 'Valor do lançamento em moeda funcional, convertida para reais.')
        ...
        VL_SLD_FIN_AUX           = struct('DataType', 'double',   'Description', 'Valor do saldo final do período em moeda funcional, convertida para reais')
        ...
        VL_SLD_FIN_REC           = struct('DataType', 'double',   'Description', 'Valor do saldo final do período.')
        VL_SLD_INI               = struct('DataType', 'double',   'Description', 'Valor do saldo inicial do período.')
        VL_SLD_INI_AUX           = struct('DataType', 'double',   'Description', 'Valor do saldo inicial do período em moeda funcional, convertida para reais.')
        ...
        VL_SLD_INI_REC           = struct('DataType', 'double',   'Description', 'Valor do saldo inicial do período.')
    end
    ...
    methods (Static = true)
        ...
        %-------------------------------------------------------%
        function status = isTableIdValid(tableIdList)
            arguments
                tableIdList (1,:) cell {mustBeText}
            end

            implementedTableIds = model.ECDBase.checkImplementedTables();
            status = cellfun(@(x) ismember(x, implementedTableIds), tableIdList);
        end
