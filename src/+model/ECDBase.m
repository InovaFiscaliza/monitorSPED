classdef (Abstract) ECDBase
    ...
    methods (Static = true)
        ...
        function tableOut = initializeCustomTable(tableId, varargin)
            arguments
                tableId {mustBeMember(tableId, {'_BALANCETE_GERAL', '_CONTAS_ANOTACAO', '_CONTAS_DESCRICAO', '_TABELA_APURACAO'})}
            end
            ...
            switch tableId
              ...
              %     );
                ...
                case '_CONTAS_ANOTACAO'
                    ...
                    tableOut = table( ...
                        accountList, ...
                        repmat(categorical("-", generalSettings.ECD.accountOptions, 'Protected', true), numAccounts, 1), ...
