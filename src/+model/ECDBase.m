classdef (Abstract) ECDBase
    ...
    properties (Constant)
        ...
        FieldSpecification = cell2table({ ...
            ...
            'Declarado?  ✎',           'categorical', [],  'Campo da tabela customizada "x_CONTAS_ANOTACAO"';
            ...
            switch tableId
              ...
              %     );
                ...
                case '_CONTAS_ANOTACAO'
                    ...
                    tableOut = table( ...
                        accountList, ...
                        repmat(categorical("-", generalSettings.context.ECD.selfDeclarationOptions, 'Protected', true), numAccounts, 1), ...
                        ...
                        repmat({''}, numAccounts, 1), ...
                        'VariableNames', {'COD_CTA', 'Declarado?  ✎', 'Apurado?  ✎', 'Interconexão?  ✎', 'Alíquota ICMS', 'Observação  ✎'} ...
                    );
