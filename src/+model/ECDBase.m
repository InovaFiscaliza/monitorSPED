    ...
    methods (Static = true)
        ...
        function implTable = checkImplementedTables()
          ...
          function tableOut = parseSplitLine(obj, tableId, fileContent, fileLayout)
            ...
            % Criar vetor lógico indicando onde a string aparece
            isMatch = contains(filenonEmptyLines, tableId{2});
            
            % Identificar as sequências consecutivas de "I155"
