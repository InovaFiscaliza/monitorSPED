        ...
        function Run(mainApp, callingApp, context, ecdObj)
            ...
            reportInfo = struct('App',      mainApp,                                                                  ...
                                ...
                                'Function', struct(...
                                                   ...
                                                   'var_EntityType',             projectData.modules.(context).ui.entity.type, ...
                                                   'var_EntityId',               projectData.modules.(context).ui.entity.id, ...
                                                   'var_EntityName',             projectData.modules.(context).ui.entity.name, ...                                                   
                                                   ...
