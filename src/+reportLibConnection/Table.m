    ...
    methods (Static)
        ...
        function jsonFileContent = scarabJsonFile(projectData, context, ecdObj, correlationKey, executionMode, issueDetails)
            ...
            jsonFileContent = struct( ...
                ...
                'userName', issueDetails.usuario.nome, ...
                'userEmail', issueDetails.usuario.email, ...
                'userDepartment', issueDetails.usuario.unidade, ...
                'userJobTitle', issueDetails.usuario.funcao, ...
                'project', struct( ...
