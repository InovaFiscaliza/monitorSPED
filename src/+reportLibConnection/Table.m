        ...
        function jsonFileContent = scarabJsonFile(projectData, context, ecdObj, correlationKey, executionMode, issueDetails)
            ...
            for ii = 1:numel(ecdObj)
                ...
                tempAccounts = join( ...
                    ...
                    'RightVariables', {'TOTAL REGISTROS', 'LISTA HISTÓRICO DEDUPLICADA'} ...
                );
                tempAccounts.('LISTA HISTÓRICO DEDUPLICADA') = cellfun(@(x) jsonencode(x), tempAccounts.('LISTA HISTÓRICO DEDUPLICADA'), 'UniformOutput', false);
            ...
            accounts = accounts(:, {'correlationKey', 'entityName', 'entityId', 'accountCode', 'description', 'entryHistoryCount', 'deduplicatedEntryHistory', 'periodYear', 'jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec', 'total', 'auditorAccountType', 'auditorIcmsConfig', 'auditorComment'});
