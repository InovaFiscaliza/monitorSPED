classdef (Abstract) Table
    ...
    methods (Static)
        ...
        function jsonFileContent = scarabJsonFile(projectData, context, ecdObj, eFiscalizaObj)
            ...
            taxEstimateSummary = struct('entityName', {}, 'entityId', {}, 'periodStart', {}, 'periodEnd', {}, 'robTelecom', {}, 'icmsTelecom', {}, 'icmsContabil', {}, 'baseCalculoPisCofins', {}, 'pisTelecom', {}, 'pisContabil', {}, 'cofinsTelecom', {}, 'cofinsContabil', {}, 'baseCalculoFustFunttel', {}, 'valorApuradoFust', {}, 'valorApuradoFunttel', {});
            files = struct('entityName', {}, 'entityId', {}, 'fileName', {}, 'fileHash', {}, 'fileEncoding', {}, 'fileSentAt', {}, 'periodStart', {}, 'periodEnd', {}, 'validationCheckedAt', {}, 'validationStatus', {}, 'validationMessage', {});
            accounts = [];
            ...
            for ii = 1:numel(ecdObj)
                ...
                taxEstimateSummary(end+1) = struct( ...
                    ...
                    'entityId', entityId, ...
                    'periodStart', ecdObj(ii).Period(1), ...
                    'periodEnd', ecdObj(ii).Period(2), ...
                ...
                for jj = 1:numel(ecdObj(ii).Sources)
                    ...
                    files(end+1) = struct( ...
                        ...
                        'periodStart', ecdObj(ii).Sources(jj).period(1), ...
                        'periodEnd', ecdObj(ii).Sources(jj).period(2), ...
            ...
            accounts = accounts(:, {'entityName', 'entityId', 'accountCode', 'description', 'jan', 'feb', 'mar', 'apr', 'may', 'jun', 'jul', 'aug', 'sep', 'oct', 'nov', 'dec', 'total', 'auditorAccountType', 'auditorIcmsConfig', 'auditorComment'});
